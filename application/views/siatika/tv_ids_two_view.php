...
<html>
  ...
  <script type="text/javascript" src="<?php echo base_url().'assets/plugins/tasktimer/dist/tasktimer.min.js' ?>"></script>
	...
	<style>
		...
		.video-title {  background: <?php echo (@$par['video_color_2'])?:'#003f12';?>; top: 0; left: 0; padding: 3px 10px;color: #fff; font-size: 90%; letter-spacing: 1px;text-align: center;}
		...
		.box {
		    background: <?php echo (@$par['box_background_2']?:'#ffffff')?>;
		}
		.box.box-default{
			border: none;
		}
...
<body class="skin-blue sidebar-mini">
	...
	<div class="row">
		<div class="col-lg-12" style="height: 85px;background:<?php echo (@$par['header_color_2'])?:'#500380';?>">	<!-- parameter : header_color -->		
			<div class="logo pull-left" style="margin-left: 15px;">
				...
				<div class="logo_app pull-right" style="margin-right: 15px;">
					<div class="pull-left">
						<h2 style="color : <?php echo (@$par['title_color_2'])?:'#ffffff';?>"><?php echo str_replace(' ','<br>',@$par['application_title_2']) ?></h2> <!-- parameter : apps_title -->
					</div>
	...
	<div class="col-lg-12" style="background:<?php echo (@$par['tv_color_2'])?:'#75ff9c';?>"><!-- parameter : color_tv -->
		<div class="row">
			<div class="col-lg-5">
				<div class="row">
					<div class="col-lg-12" style="margin-top: 10px;">
						<div class="box box-default" style="height:<?php echo (@$par['box_berita_height_2'])?:'300';?>px;">
							<div class="box-header with-border" style="background:<?php echo (@$par['berita_color_2'])?:'#424bf4';?>"><!-- parameter : background_berita -->
			                	<h3 class="box-title" style="color:<?php echo (@$par['berita_text_color_2'])?:'#ffffff';?>"><b><?php echo (@$par['berita_title_2'])?:'-';?></b></h3><!-- parameter : warna_berita -->
			              	</div>
				          	<div class="box-body no-padding" style="height:<?php echo (@$par['box_berita_height_2'])?(240 + (@$par['box_berita_height_2'] - 300)):'240';?>px; overflow:hidden;">			               
					...
					<div class="col-lg-12">
						<div class="box box-default" style="height:<?php echo (@$par['box_agenda_height_2'])?:'300';?>px;">
							<div class="box-header with-border" style="background:<?php echo (@$par['agenda_color_2'])?:'#210a00';?>">
	                			<h3 class="box-title" style="color:<?php echo (@$par['agenda_text_color_2'])?:'#ffffff';?>"><b><?php echo (@$par['agenda_title_2'])?:'-';?></b></h3><!-- parameter : background_kegiatan -->
	              			</div>
				          	<div class="box-body no-padding" style="height:<?php echo (@$par['box_agenda_height_2'])?(240 + (@$par['box_berita_height_2'] - 300)):'240';?>px; overflow:hidden;"><!-- parameter : warna_kegiatan -->			               
								<div id="box-pengumuman" style="padding:0px 10px;">
			...
			<div class="col-lg-7" style="margin-bottom: 10px;padding:0px;">
              			<div class="col-lg-6" style="margin-top: 10px !important;padding-left:4px;">
              				<div class="box box-default" style="height:<?php echo (@$par['box_informasi_height_2'])?:'300';?>px;">
								<div class="box-header with-border" style="background:<?php echo (@$par['informasi_color_2'])?:'#510045';?>"><!-- parameter : background_pengumuman -->
				                	<h3 class="box-title" style="color:<?php echo (@$par['informasi_text_color_2'])?:'#ffffff';?>"><b><?php echo (@$par['informasi_title_2'])?:'-';?></b></h3><!-- parameter : warna_pengumuman -->
				              	</div>
					          	<div class="box-body no-padding" style="height:<?php echo (@$par['box_informasi_height_2'])?(250 + (@$par['box_informasi_height_2'] - 300)):'250';?>px; overflow:hidden;">			               
					...
					<div class="col-lg-6" style="margin-top: 10px !important;padding-left:4px;">
						<div class="box box-default" style="height:<?php echo (@$par['box_galeri_height_2'])?:'300';?>px;">
							<div class="box-header with-border" style="background:<?php echo (@$par['galeri_color_2'])?:'#e80209';?>"><!-- parameter : background_foto -->
			                	<h3 class="box-title" style="color:<?php echo (@$par['galeri_text_color_2'])?:'#ffffff';?>"><b><?php echo (@$par['galeri_title_2'])?:'-';?></b></h3><!-- parameter : warna_foto -->
			              	</div>
			              	<div class="box-body">
				           		<!-- postGAL1 -->
									<div id="box-pengumuman" style="padding:0px 10px;">
              			...
              			<div class="col-lg-6" style="padding-left:4px;">
              				<div class="box box-default" style="height:<?php echo (@$par['box_pengumuman_height_2'])?:'300';?>px;">
								<div class="box-header with-border" style="background:<?php echo (@$par['pengumuman_color_2'])?:'#0c2c3a';?>"><!-- parameter : background_pengumuman -->
				                	<h3 class="box-title" style="color:<?php echo (@$par['pengumuman_text_color_2'])?:'#ffffff';?>"><b><?php echo (@$par['pengumuman_title_2'])?:'-';?></b></h3><!-- parameter : warna_pengumuman -->
				              	</div>
					          	<div class="box-body no-padding" style="height:<?php echo (@$par['box_pengumuman_height_2'])?(250 + (@$par['box_pengumuman_height_2'] - 300)):'250';?>px; overflow:hidden;">			               
									<div id="" style="padding:0px 10px;">
              			...
              			<div class="col-lg-6" style="padding-left:4px;">
              				<div class="box box-default" style="height:<?php echo (@$par['box_video_height_2'])?:'300';?>px;">
							<div class="box-header with-border" style="background:<?php echo (@$par['video_color_2'])?:'#003f12';?>"><!-- parameter : background_video -->
		                		<h3 class="box-title" style="color:<?php echo (@$par['video_text_color_2'])?:'#ffffff';?>"><b><?php echo (@$par['video_title_2'])?:'-';?></b></h3><!-- parameter : warna_video -->
		              		</div>
		              		<div class="box-body" style="height:250px; overflow:hidden;">
									<div class="box-body no-padding" style="overflow:hidden;">
										<div class="marquee"></div>
										<div id="video0">
											<video autoplay <?php echo (@$par['video_voice_2'] == 'muted')?'muted':null;?>  preload id="video1" style="width: 100%; height: 100%;  object-fit: fill;">Your browser does not support HTML5 Audio!</video>
										</div>
...
<script type="text/javascript">
	...
	<div class="row">
		<div class="col-lg-12">
			<h3 class="jam" id="jam" style="color: <?php echo (@$par['date_text_color_2'])?:'#ffffff';?>;background: <?php echo (@$par['date_background_color_2'])?:'#f8c300';?>;"></h3>
