 ...
 */
class ajax_pagination_pelatihan{
    ...
    var $anchor_class		= '';
    var $show_count         = true;
    var $link_func          = 'getDataPelatihan';
    var $loading            = '.loading';
	...
	function create_links($jeda=3){
	  ...
	  //           $info = 'Showing : ' . $this->total_rows;
        ...
        function getDataPelatihan(page){  
            $.ajax({
                method: "POST",
           ...
           // setTimeout(getDataPelatihan(page), 9000);
           //return false;
        }
        ...
        $(document).ready(function() {
		 ...
		 var page_news = $('#page_news').val();
		  // setInterval(getDataPelatihan(page_news), 90000000);
