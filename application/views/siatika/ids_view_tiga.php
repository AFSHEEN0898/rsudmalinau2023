...
<html>
  ...
  <script type="text/javascript" src="<?php echo base_url().'assets/plugins/tasktimer/dist/tasktimer.min.js' ?>"></script>
	...
	<body class="skin-blue sidebar-mini" style="background: radial-gradient(#ffffff,<?php echo @$set_warna_latar->warna_latar;?>)">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="col-lg-5" style="padding: 5px;padding-left:0px !important;">
		...
		<script type="text/javascript">
			/*function teks_bergerak() {
				$.ajax({
					url: 'http://localhost/siap/infopublik/runningtext/folder_pegawai',
					cache: false,
