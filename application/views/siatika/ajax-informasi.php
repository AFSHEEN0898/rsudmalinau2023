<?php
	...
	foreach ($informasi->result() as $n) {
		...
		<div class="informasi informasi-<?php echo $n->id_article ?>">
			<div class="informasi-title" style="border-bottom: 1px solid #000;">
				<div class="row">
					<div class="col-lg-12" style="font-size: 16px;"><?php echo $n->title ?></div>
					
				</div>
			</div>
			<div class="luar" style="min-height:220px; margin-top:10px;text-align:justify;word-spacing:3px;">
	...
	echo '<div class="alert alert-warning alert-dismissible">Belum ada informasi !</div>';
		echo $paging;
	} ?>
