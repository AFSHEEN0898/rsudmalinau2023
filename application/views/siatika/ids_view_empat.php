...
<html>
  ...
  <script type="text/javascript" src="<?php echo base_url().'assets/plugins/tasktimer/dist/tasktimer.min.js' ?>"></script>
		...
		<style>
			...
			.tanggal{
				border-bottom: 40px solid #f00f00;
			...
			.foto-title {  background: <?php echo @$par['galeri_color'];?>; top: 0; left: 0; padding: 3px 10px; margin-bottom: 0px; height: 26px;
	...
	<div class="row">
			...
			<div class="col-lg-12">
				<div class="col-lg-6" style="padding: 5px; <?php echo (!empty($set_widget_1->lebar) ? 'width:'.$set_widget_1->lebar.'% !important;' : null);?>">
				...
				<div class="col-lg-6" style="padding: 5px; <?php echo (!empty($set_widget_2->lebar) ? 'width:'.$set_widget_2->lebar.'% !important;' : null);?>">
					<div class="box box-default box-konten">
				...
				<div class="col-lg-6" style="padding: 5px; <?php echo (!empty($set_widget_3->lebar) ? 'width:'.$set_widget_3->lebar.'% !important;' : null);?>">
					<div class="box box-default box-konten">
				...
				<div class="col-lg-6" style="padding: 5px; <?php echo (!empty($set_widget_4->lebar) ? 'width:'.$set_widget_4->lebar.'% !important;' : null);?>">
					<div class="box box-default box-konten">
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				 ...
				 get_ids(5, 'postWidLima', 'page_lima', 'wid-kolom-lima', 'getDataIDSLima', 'postLima');
