		...
		if (!empty($indie) and $indie == TRUE) {
			...
			<div class="col-lg-6">
				<?php if (!empty($row->id_pegawai)) {
					...
					<!-- <div class="form-group"><label><?php echo $lbl ?></label>
						<input type="file" name="foto" id="frm_file">
					</div> -->
...
<div class="card-footer">
	...
	<button href="#" class="btn btn-success btn-save-all float-right"><i class="fa fa-save"></i> &nbsp; Simpan</button>
	<div class="clear"></div>
</div>
