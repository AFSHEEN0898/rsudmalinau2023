...
<html>
  ...
  <script type="text/javascript" src="<?php echo base_url().'assets/plugins/tasktimer/dist/tasktimer.min.js' ?>"></script>
	...
	<style>
		...
		.foto-title {  background: #000000; top: 0; left: 0; padding: 3px 10px;color: #ffffff; font-size: 80%; letter-spacing: 1px;text-align: center;}
		.video-title {  background: #000000; top: 0; left: 0; padding: 3px 10px;color: #ffffff; font-size: 90%; letter-spacing: 1px;text-align: center;}
	...
	<div class="col-lg-12" style="background:<?php echo (@$par['tv_color'])?:'#75ff9c';?> ;padding:5px"><!-- parameter : color_tv -->
		<div class="row" style="padding:1px 30px 10px 25px">
			<div class="col-lg-5 no-padding" style="padding-left:10px;">
				<div class="row">
					<div class="col-lg-12" style="">
						<div class="box box-default" style="height:<?php echo (@$par['box_berita_height'])?:'320';?>px;background:<?php echo (@$par['berita_background_color'])?:'#ffffff';?>;color:<?php echo (@$par['berita_text_color'])?:'#ffffff';?>">
				          	...
				          	<div class="box-body no-padding" style="height:<?php echo (@$par['box_berita_height'])?((@$par['box_berita_height'] - 40)):'270';?>px; overflow:hidden;">			               
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="box box-default" style="height:<?php echo (@$par['box_agenda_height'])?:'320';?>px;background:<?php echo (@$par['agenda_background_color'])?:'#ffffff';?>;color:<?php echo (@$par['agenda_text_color'])?:'#ffffff';?>">
				          	...
				          	<div class="box-body no-padding" style="height:<?php echo (@$par['box_agenda_height'])?@$par['box_agenda_height'] - 40:'190';?>px; overflow:hidden;"><!-- parameter : warna_kegiatan -->			               
			...
			<div class="col-lg-3">
				<div class="row">
					<div class="col-lg-12" style="">
              				<div class="box box-default" style="height:<?php echo (@$par['box_informasi_height'])?:'300';?>px;background:<?php echo (@$par['informasi_background_color'])?:'#ffffff';?>;color:<?php echo (@$par['informasi_text_color'])?:'#ffffff';?>;">
								<div class="box-header" style="background:linear-gradient(to right, <?php echo (@$par['informasi_header_color'])?:'#510045';?>,<?php echo (@$par['informasi_header_text_color'])?:'#ffffff';?>);"><!-- parameter : background_informasi -->
					          	...
					          	<div class="box-body no-padding" style="height:<?php echo (@$par['box_informasi_height'])?((@$par['box_informasi_height'] - 50)):'250';?>px; overflow:hidden;">			               
				...
				<div class="row">
					<div class="col-lg-12">
              				<div class="box box-default" style="height:<?php echo (@$par['box_pengumuman_height'])?:'300';?>px;background:<?php echo (@$par['pengumuman_background_color'])?:'#ffffff';?>;color:<?php echo (@$par['pengumuman_text_color'])?:'#ffffff';?>;">
								<div class="box-header" style="background:linear-gradient(to right, <?php echo (@$par['pengumuman_header_color'])?:'#510045';?>,<?php echo (@$par['pengumuman_header_text_color'])?:'#ffffff';?>);"><!-- parameter : background_pengumuman -->
					          	...
					          	<div class="box-body no-padding" style="height:<?php echo (@$par['box_pengumuman_height'])?((@$par['box_pengumuman_height'] - 60)):'250';?>px; overflow:hidden;">			               
									<div id="" style="padding:0px 10px;">
			...
			<div class="col-lg-4 no-padding">
				<div class="row">
					<div class="col-lg-12" style="">
						<div class="box box-default" style="height:<?php echo (@$par['box_galeri_height'])?:'300';?>px;background:<?php echo (@$par['galeri_background_color'])?:'#ffffff';?>;color:<?php echo (@$par['galeri_text_color'])?:'#ffffff';?>">
							<div class="box-header" style="background:linear-gradient(to right, <?php echo (@$par['galeri_header_color'])?:'#510045';?>,<?php echo (@$par['galeri_header_text_color'])?:'#ffffff';?>);"><!-- parameter : background_galeri -->
			              	...
			              	<div class="box-body no-padding">
				           		<!-- postGAL1 -->
									...
									<img src="<?php echo base_url().'uploads/sitika/galeri/foto/'.$f->foto; ?>" style="min-width:100%; height:<?php echo (@$par['photo_height'])?:'257';?>px;border-bottom-left-radius:5px;border-bottom-right-radius:5px;"/>
				...
				<div class="row">
					<div class="col-lg-12">
              				<div class="box box-default" style="height:<?php echo (@$par['box_video_height'])?:'300';?>px;background:<?php echo (@$par['video_background_color'])?:'#ffffff';?>;color:<?php echo (@$par['video_text_color'])?:'#ffffff';?>">
		              		...
		              		<div class="box-body no-padding" style="height:<?php echo (@$par['video_height'])?(@$par['video_height'] + 2):'282';?>px; overflow:hidden;">
									<div class="box-body no-padding" style="overflow:hidden;">
										<div class="marquee"></div>
										<div id="video0">
											<video autoplay <?php echo (@$par['video_voice'] == 'muted')?'muted':null;?> preload id="video1" style="width: 100%; height: <?php echo (@$par['video_height'])?(@$par['video_height']):'280';?>px;  object-fit: fill;">Your browser does not support HTML5 Audio!</video>
										</div>
											    ...
											    if (supportsAudio) {
											        var index = 0,
											            ...
											            loadTrack = function (id) {
											            	var n = tracks[id].name.length;
											            	var marquee;
											            	if (n > 70){
											            		marquee = '<marquee>'+tracks[id].name+'</marquee>';
											            	}else{
											            		marquee = tracks[id].name;
											            	}
											                $('.plSel').removeClass('plSel');
											                $('#plList li:eq(' + id + ')').addClass('plSel');
											                $('.marquee').html('<div class="video-title" style="padding-bottom: 0px;">'+marquee+'</div>');
