...
<?php
	...
	foreach ($dtduk->result() as $n) {
		...
		<div class="informasi informasi-<?php echo $n->id_article ?>" style="margin:5px;font-size: <?php echo $font_size;?>px !important">
			...
			<div class="pengumuman-info" style="min-height:<?php echo (@$height_kolom)?((@$height_kolom - 60)):'250';?>px; margin-top:10px;text-align:justify;line-height:20px;word-spacing:3px;">
				<div class="dalampengumuman-info" style="font-size: <?php echo $font_size;?>px !important;">
	...
	<script>
			$(document).ready(function() {
				//$('.pengumuman-info').height($('.box-penxg').height()-130);
				var ombox = $('.pengumuman-info').height()-35;
				$('.dalampengumuman-info').each(function() {
						set_peng($(this));
				});
				//alert(ombox);
				// alert(ombox);
