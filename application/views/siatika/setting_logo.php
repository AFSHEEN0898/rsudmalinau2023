        ...
        <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
            ...
            foreach ($tabs as $t) {
                ...
                echo '<li class="nav-item">
					<a' . (!empty($t['url']) ? ' class="nav-link ' . $aktif . '"  id="custom-tabs-two-home-tab" role="tab" style="padding:10px" aria-controls="custom-tabs-two-home" aria-selected="true" href="' . $t['url'] . '"' : null) . '>' . $t['text'] . '</a></li>';
            }
            ?>
        </ul>
    <?php } ?>
    ...
    <div class="card-body table-responsive<?php if (!empty($overflow)) echo " over-width" ?>">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-lg-6">
                    <!-- kolom kiri -->
                    <img src="<?php echo base_url('uploads/logo/' . $vals['pemerintah_logo']); ?>" style="width:50%;">

                    <br>
                    <br>
                    <label>Logo Instansi</label>
                    <?php echo
                    form_hidden('keys', 'pemerintah_logo');
                    ...
                    <div class="form-group">
                        <div class="custom-file">
                            <input type="file" name="vals" class="custom-file-input inp_reload" id="header_on" required>
