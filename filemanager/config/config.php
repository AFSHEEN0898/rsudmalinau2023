...
define('USE_ACCESS_KEYS', true); #false); // TRUE or FALSE     ,
...
$config = array(
    ...
    */
	...
	'base_url' => 'http://localhost/siatika/',
	/*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |
    */
	'thumbs_base_path' => '../../tmp/thumbs/',/*  ../thumbs/ */
    ...
    |
    */
	'thumbs_upload_dir' => '/tmp/thumbs/', /*'/thumbs/'*/
    ...
    */
	...
	'access_keys' => array('myPvKey', 'yesjogja'),
    ...
    */
	...
	'hidden_files'                            => array('config.php', 'index.php'),
