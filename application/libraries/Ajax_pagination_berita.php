	...
	function create_links($jeda=3){
	  ...
	  //           $info = 'Showing : ' . $this->total_rows;
        ...
        function getDataBerita(page){  
           ...
           // setTimeout(getDataBerita(page), 9000);
           //return false;
        }
        ...
        $(document).ready(function() {
		 ...
		 var page_news = $('#page_news').val();
		  // setInterval(getDataBerita(page_news), 90000000);
