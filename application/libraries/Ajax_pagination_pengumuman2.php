 ...
 */
class ajax_pagination_pengumuman2{
    ...
    var $anchor_class		= '';
    var $show_count         = true;
    var $link_func          = 'getDatapengumuman2';
    var $loading            = '.loading';
	...
	function create_links($jeda=3){
	  ...
	  //           $info = 'Showing : ' . $this->total_rows;
        ...
        function getDatapengumuman2(page_pengumuman2){  
            $.ajax({
                method: "POST",
                url: "<?php echo $this->base_url; ?>"+page_pengumuman2,
                data: { page_pengumuman2: page_pengumuman2 },
                beforeSend: function(){
           ...
           // setTimeout(getDatapengumuman2(page), 9000);
           //return false;
        }

        $(document).ready(function() {
		  // run the first time; all subsequent calls will take care of themselves
		 var page_pengumuman2 = $('#page_pengumuman2').val();
		  // setInterval(getDatapengumuman2(page_pengumuman2), 90000000);
		  ...
		  // timer.stop();
			...
			var task = {
			    ...
			    callback: function (task) {
			    	getDatapengumuman2(page_pengumuman2);
	...
	function getAJAXlink($count, $text='') {
		...
		return '<input type="hidden" id="page_pengumuman2" value="'.$pageCount.'">';
